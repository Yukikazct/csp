...
# 二、基础算法
## 1. 整数二分查找
**适用情形**：数组**有序**，找第一个≥x / 最后一个≤x、答案具有单调性、最小最大值问题
```cpp
// 找第一个 >= x 的位置
...
## 2. 三分查找
**适用情形**：求**单峰函数**最值（凸函数最小值/凹函数最大值）、几何最优、二次函数极值
```cpp
...
## 3. LIS 最长上升子序列
**适用情形**：求**最长不下降/上升序列**、O(n log n) 最优
```cpp
